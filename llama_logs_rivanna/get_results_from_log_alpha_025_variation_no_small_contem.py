...
def main():
    base_path = "/home/nee7ne/EfficientCoT/logs/variation_no_small_contemp_gen"
    dataset_folders = ["data_coin_flip", "data_multi_arith", "data_svamp"]
    output_csv = "alpha_025_variation_no_small_contemp_gen_results.csv"
